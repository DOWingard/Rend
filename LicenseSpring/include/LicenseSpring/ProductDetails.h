...
/// \details Product information can be obtained through the backend using
/// BaseManager::getProductDetails()
...
public:
    ...
    /// \return LSAuthMethod object stating the product authorization method, i.e.
    /// AuthMethodKeyBased or AuthMethodUserBased.
    ...
    /// \brief Getter for product custom fields.
    /// \return std::vector of custom fields for current product.
