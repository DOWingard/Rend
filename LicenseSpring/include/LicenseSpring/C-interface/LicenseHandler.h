...
extern "C"
{
    ...
    LS_API typedef void (*LSWatchdogCallback)(
        const char *message, enum LSErrorCode errorCode, void *handler);
    ...
    LS_API typedef struct LSLicenseHandler
    {
        ...
        LSProductDetails *(*getProductDetailsWithCustomFieldsAndEnv)(struct LSLicenseHandler *self,
            bool includeLatestVersion, bool includeCustomFields, const char *env);
        LSProductDetails *(*getProductDetails)(
            struct LSLicenseHandler *self, bool includeLatestVersion);
        struct LSLicenseID (*getTrialLicense)(
            struct LSLicenseHandler *self, LSCustomer *user, const char *licensePolicy);
        struct LSLicenseID (*getTrialLicenseByEmail)(
            struct LSLicenseHandler *self, const char *userEmail);
        const char *(*getSSOUrl)(
            struct LSLicenseHandler *self, const char *accountCode, bool useAuthCode);
        ...
        bool (*changePassword)(struct LSLicenseHandler *self, const char *password,
            const char *newPassword, const char *user);
        LSInstallationFile *(*checkLicense)(struct LSLicenseHandler *self);
        LSInstallationFile *(*checkLicenseEx)(struct LSLicenseHandler *self, const char *channel,
            const char *env, bool includeExpiredFeatures);
        int (*getVersionList)(struct LSLicenseHandler *self, struct LSLicenseID licenseID,
            int *lengths, char **versionList);
        ...
        LSInstallationFile *(*getInstallFile)(
            struct LSLicenseHandler *self, struct LSLicenseID licenseID, const char *version);
        LSInstallationFile *(*getInstallFileEx)(struct LSLicenseHandler *self,
            struct LSLicenseID licenseID, const char *version, const char *channel,
            const char *env);
        void (*sendDeviceData)(
            struct LSLicenseHandler *self, struct LSCustomField *data, int dataSize);
        ...
        void (*borrowFloatingLicenseWithPassword)(
            struct LSLicenseHandler *self, uint32_t hours, uint32_t days, const char *password);
        void (*borrowFloatingLicenseTill)(
            struct LSLicenseHandler *self, const char *borrowEndDateTime);
        void (*borrowFloatingLicenseTillWithPassword)(
            struct LSLicenseHandler *self, const char *borrowEndDateTime, const char *password);
        void (*releaseFloatingLicense)(struct LSLicenseHandler *self);
        void (*registerFloatingFeature)(
            struct LSLicenseHandler *self, const char *featureCode, bool addToWatchdog);
        void (*releaseFloatingFeature)(struct LSLicenseHandler *self, const char *featureCode);
        const char *(*getAirGapActivationCode)(
            struct LSLicenseHandler *self, const char *initializationCode, const char *licenseKey);
        const char *(*getAirGapDeactivationCode)(
            struct LSLicenseHandler *self, const char *initializationCode);
        // ------------------------------------------------------------
        ...
        void (*updateFeatureConsumption)(
            struct LSLicenseHandler *self, const char *featureCode, int value, bool saveLicense);
        ...
        void (*setupLicenseWatchdog)(
            struct LSLicenseHandler *self, LSWatchdogCallback callback, unsigned long timeout);
        void (*resumeLicenseWatchdog)(struct LSLicenseHandler *self);
        void (*stopLicenseWatchdog)(struct LSLicenseHandler *self);
        void (*setupFeatureWatchdog)(
            struct LSLicenseHandler *self, LSWatchdogCallback callback, unsigned long timeout);
        void (*resumeFeaturewatchdog)(struct LSLicenseHandler *self);
        void (*stopFeatureWatchdog)(struct LSLicenseHandler *self);
        void (*relinkLicense)(struct LSLicenseHandler *self,
            enum DeviceIDAlgorithm deviceIdAlgorithm, const char *userPassword);
        ...
        const wchar_t *(*createOfflineActivationFile)(struct LSLicenseHandler *self,
            struct LSLicenseID licenseID, const wchar_t *activationRequestFile);
        void (*activateLicenseOffline)(
            struct LSLicenseHandler *self, const wchar_t *activationResponseFile);
        const wchar_t *(*deactivateLicenseOffline)(
            struct LSLicenseHandler *self, const wchar_t *deactivationRequestFile);
        bool (*updateOffline)(
            struct LSLicenseHandler *self, const wchar_t *path, bool resetConsumption);
        void (*activateAirGapLicense)(struct LSLicenseHandler *self, const char *confirmationCode,
            const wchar_t *policyFile, const char *licenseKey, unsigned long policyId);
        void (*deactivateAirGapLicense)(
            struct LSLicenseHandler *self, const char *confirmationCode);
        // ------------------------------------------------------------
        ...
        const char *(*getOrderStoreId)(struct LSLicenseHandler *self);
        ...
        struct tm (*getLicenseActivationDate)(struct LSLicenseHandler *self);
        struct tm (*getLicenseActivationDateUtc)(struct LSLicenseHandler *self);
        LSCompany *(*getCompany)(struct LSLicenseHandler *self);
        LSCustomer *(*getLicenseOwner)(struct LSLicenseHandler *self);
        bool (*hasLicenseFeatures)(struct LSLicenseHandler *self);
        struct LSLicenseFeature *(*getLicenseFeature)(
            struct LSLicenseHandler *self, const char *featureCode);
        ...
        // No Internet, network timeout and server errors can be ignored
        bool (*canIgnoreError)(struct LSLicenseHandler *self);
        void (*clearErrorInfo)(struct LSLicenseHandler *self);
        // ------------------------------------------------------------
    ...
    // This function will also free current configuration, you do not need to explicitly call
    // FreeLSConfiguration
