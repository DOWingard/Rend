...
/// \details This class is in use for passing device variables to the backend (see
...
public:
    ...
    /// \details To correctly send strings that contain Unicode characters, make sure the string is
    /// encoded in UTF-8,\n for example:
    ...
    /// \brief Getter method for device variable date time in UTC when it was updated on the
    /// backend.
    /// \details This value is available after getting device variables data from the backend.
